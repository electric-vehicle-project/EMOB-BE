...
public class DeliveryController {
    ...
    DeliveryService deliveryService;
     ...
     public ResponseEntity<APIResponse<Void>> deleteDelivery (@RequestParam @PathVariable("id") UUID id) {
...
//            )
//    )
//    public ResponseEntity<APIResponse<DeliveryItemResponse>> createDeliveryItem (@Valid @RequestBody DeliveryItemRequest request,
...
//    }
    ...
    public ResponseEntity<APIResponse<DeliveryItemResponse>> confirmItem (@RequestParam @PathVariable("id") UUID id) {
    ...
    public ResponseEntity<APIResponse<DeliveryItemResponse>> viewDeliveryItem (@RequestParam @PathVariable("id") UUID id) {
        return ResponseEntity.ok(deliveryService.viewDeliveryItem(id));
    }

    @GetMapping("/item/view-all")
    @Operation(
            summary = "View All Deliveries Item"
    )
    ...
    public ResponseEntity<APIResponse<DeliveryItemResponse>> updateDeliveryItem (@RequestParam @PathVariable("id") UUID id,
