...
public class ElectricVehicleController {
  ...
  public ResponseEntity<APIResponse<?>> getDemandForecastFromAI(@RequestParam  String model) {
    APIResponse<?> forecasts = vehicleService.getDemandForecastFromAI(model);
    return ResponseEntity.ok(forecasts);
  }
  @GetMapping("/createDemandForecasts")
  public ResponseEntity<List<Map<String, Object>>> createDemandForecasts(@RequestParam  String model) {
    List<Map<String, Object>> forecasts = vehicleService.createDemandForecasts(model);
    return ResponseEntity.ok(forecasts);
  }
}
