...
@Tag(
    ...
    description = "Endpoints for scheduling and managing vehicle test drives")
public class TestDriveController {
  ...
  public ResponseEntity<APIResponse<PageResponse<TestDriveResponse>>> viewAllSchedules(
      ...
      @Parameter(description = "Page size (default 10)") @RequestParam(defaultValue = "10")
          int size,
      @Parameter(description = "Keyword search by customer name or location")
          @RequestParam(required = false)
          String keyword,
      @Parameter(description = "Filter by test drive status") @RequestParam(required = false)
  ...
  @Operation(
      ...
      description =
          "Returns list of vehicles not scheduled for any test drive during the selected time range"
              + " (adds 30 min before and after for preparation).")
